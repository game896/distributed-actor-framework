...
type ActorServiceClient interface {
	SendMessage(ctx context.Context, in *Envelope, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *actorServiceClient) SendMessage(ctx context.Context, in *Envelope, opts ...grpc.CallOption) (*Ack, error) {
...
type ActorServiceServer interface {
	SendMessage(context.Context, *Envelope) (*Ack, error)
...
func (UnimplementedActorServiceServer) SendMessage(context.Context, *Envelope) (*Ack, error) {
...
func _ActorService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActorServiceServer).SendMessage(ctx, req.(*Envelope))
	}
